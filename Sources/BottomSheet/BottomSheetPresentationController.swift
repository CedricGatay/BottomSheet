...
public final class BottomSheetPresentationController: UIPresentationController {
    ...
    private var adaptiveFrame: CGRect {
        ...
        let safeAreaFrame = containerView.bounds.inset(by: containerView.viewSafeAreaInsets)
        ...
        targetHeight += containerView.viewSafeAreaInsets.bottom
    ...
    private var toSafeAreaTopFrame: CGRect {
        ...
        var frame = safeAreaFrame
        frame.origin.y += containerView.viewSafeAreaInsets.bottom
        frame.size.width = targetWidth
        return frame
    }
